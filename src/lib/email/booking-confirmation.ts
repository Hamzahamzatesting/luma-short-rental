...
export function bookingConfirmationSubject(listingTitle: string) {
  return `Your reservation at ${listingTitle} is confirmed — LUMA`;
}
        ...
        <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="max-width:520px; width:100%; background-color:#FAF1F2; border-radius:6px; overflow:hidden; border:1px solid #E9E2D6;">
          ...
          <tr>
            <td align="center" style="padding: 32px 40px 8px;">
              <div style="display:inline-block; padding:5px 14px; border:1px solid #D4AF37; border-radius:20px; font-size:10px; letter-spacing:1.5px; text-transform:uppercase; color:#B8933F; margin-bottom:18px;">
              ...
              <p style="margin:0; font-size:14px; line-height:22px; color:#4a423c;">
                We look forward to hosting you. Here are your reservation details.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 24px 40px 0;">
              <img src="${listingImage}" alt="${listingTitle}" width="440" style="width:100%; max-width:440px; height:auto; border-radius:4px; display:block;" />
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 20px 40px 0;">
              ...
              <h2 style="margin:0; font-family: Georgia, 'Times New Roman', serif; font-weight:400; font-size:19px; color:#0B0F14;">${listingTitle}</h2>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 20px 40px 0;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-top:1px solid #E9E2D6; border-bottom:1px solid #E9E2D6;">
                ...
                <tr>
                  <td style="padding:0 0 16px; width:50%;">
                    <p style="margin:0 0 3px; font-size:10px; letter-spacing:1px; text-transform:uppercase; color:#9a8f85;">Guests</p>
                    <p style="margin:0; font-size:14px; color:#0B0F14;">${guests} guest${guests > 1 ? "s" : ""}</p>
                  </td>
                  <td style="padding:0 0 16px; width:50%;">
                    <p style="margin:0 0 3px; font-size:10px; letter-spacing:1px; text-transform:uppercase; color:#9a8f85;">Nights</p>
                    <p style="margin:0; font-size:14px; color:#0B0F14;">${nights}</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding: 20px 40px 0;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding:4px 0; font-size:13px; color:#4a423c;">${money(pricePerNight, currency)} &times; ${nights} night${nights > 1 ? "s" : ""}</td>
                  <td align="right" style="padding:4px 0; font-size:13px; color:#4a423c;">${money(subtotal, currency)}</td>
                </tr>
                <tr>
                  <td style="padding:4px 0; font-size:13px; color:#4a423c;">Cleaning fee</td>
                  <td align="right" style="padding:4px 0; font-size:13px; color:#4a423c;">${money(cleaningFee, currency)}</td>
                </tr>
                <tr>
                  <td style="padding:4px 0 12px; font-size:13px; color:#4a423c;">Service fee</td>
                  <td align="right" style="padding:4px 0 12px; font-size:13px; color:#4a423c;">${money(serviceFee, currency)}</td>
                </tr>
                <tr>
                  <td style="padding:12px 0 0; font-size:14px; font-weight:600; color:#0B0F14; border-top:1px solid #E9E2D6;">Total</td>
                  <td align="right" style="padding:12px 0 0; font-size:14px; font-weight:600; color:#0B0F14; border-top:1px solid #E9E2D6;">${money(total, currency)}</td>
                </tr>
              </table>
            </td>
          </tr>
