    ...
    <section className="relative flex min-h-[92vh] items-end overflow-hidden bg-midnight">
      ...
      <RevealGroup className="relative mx-auto w-full max-w-7xl px-6 pb-20 pt-40 md:px-10 md:pb-24">
        ...
        <motion.p
          ...
          className="mb-4 text-center text-xs font-medium uppercase tracking-label text-gold md:text-left"
        >
        ...
        <motion.h1
          variants={revealItemVariants}
          className="text-center font-serif text-4xl leading-[1.1] text-ivory sm:text-5xl md:text-left md:text-6xl lg:text-7xl"
        >
          Extraordinary stays,
          <br />
          remarkable memories.
        ...
        <motion.p
          variants={revealItemVariants}
          className="mx-auto mt-6 max-w-xl text-center text-base text-ivory/75 md:mx-0 md:text-left"
        >
